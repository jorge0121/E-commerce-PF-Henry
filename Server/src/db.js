...
// Conexion
const database = new Sequelize(`postgresql://postgres:FaB-A3GB3G3f-3Cf-D43-ccccF1*EggA@postgres.railway.internal:5432/railway`,
  { logging: false,
    native: false, 
  dialectOptions: {
    ssl: {
...
//postgresql://postgres:FaB-A3GB3G3f-3Cf-D43-ccccF1*EggA@monorail.proxy.rlwy.net:30475/railway
//postgresql://postgres:-3EADg6-f3Df1g*bFDb4BC*23GeDbBag@viaduct.proxy.rlwy.net:49375/railway
//postgresql://postgres:FaB-A3GB3G3f-3Cf-D43-ccccF1*EggA@postgres.railway.internal:5432/railway
ModelsBook(database);
